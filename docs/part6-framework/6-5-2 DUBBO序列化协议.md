...
![效率及其它序列化工具](https://img-blog.csdnimg.cn/20190622113221847.png)
...
![几种序列化方式的性能比较](https://img-blog.csdnimg.cn/20190622114300670.png)

- **可以看到序列化的性能：hession>protobuf>fastjson>json**

- **但是压缩的字节数性能：protobuf>fastjson>json>hession**
